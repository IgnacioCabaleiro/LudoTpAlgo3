...
public class TestLudo {
	...
	public void testCalcularDestino() {
		...
		var ficha = new Ficha(Color.AMARILLO, Estado.JUGANDO, new Casilla(Tipo.NORMAL, 5), 0);
	...
	public void mueveCorrectamente() {
		var ficha = new Ficha(Color.ROJO, Estado.JUGANDO, new Casilla(Tipo.NORMAL, 5), 0);
		tablero = new Tablero();
	...
	public void comeCorrectamente() {
		...
		var ficha1 = new Ficha(Color.AMARILLO, Estado.JUGANDO, new Casilla(Tipo.NORMAL, 5),0);
		var ficha2 = new Ficha(Color.ROJO, Estado.JUGANDO, new Casilla(Tipo.NORMAL, 2),0);
		tablero = new Tablero();
		var ludo = new Ludo();
	...
	public void whenEstaEnCasillaProtegidaThenNoLoPuedenComer() {
		...
		var ficha1 = new Ficha(Color.AZUL, Estado.JUGANDO, new Casilla(Tipo.PROTEGIDO, 39) , 0);
		var ficha2 = new Ficha(Color.ROJO, Estado.JUGANDO, new Casilla(Tipo.NORMAL, 36) , 0);	
	...
	public void whenTodasFichasGanadasthenTermina() {
		...
		var ficha1 = new Ficha(Color.ROJO, Estado.FINAL, new Casilla(Tipo.FINAL, 3),0);	
		var ficha2 = new Ficha(Color.ROJO, Estado.FINAL, new Casilla(Tipo.FINAL, 3),1);	
		var ficha3 = new Ficha(Color.ROJO, Estado.FINAL, new Casilla(Tipo.FINAL, 3),2);	
		var ficha4 = new Ficha(Color.ROJO, Estado.FINAL, new Casilla(Tipo.FINAL, 3),3);	
